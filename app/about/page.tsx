    ...
    <div className="max-w-7xl mx-auto px-6 py-10 md:py-16 flex flex-col gap-16 md:gap-24 pb-20">
      ...
      <section className="flex flex-col gap-8">
        ...
        <div className="gold-gradient-border rounded-3xl p-8 md:p-12 shadow-2xl max-w-4xl mx-auto">
          <p className="text-sm sm:text-base md:text-lg text-white/90 leading-relaxed font-light text-center sm:text-left flex flex-col gap-6">
            <span>
              At <strong className="text-brand-gold font-semibold">Take Five</strong>, we believe that the best moments in life are the ones where you pause and savor. Born in the heart of the city, our mission was simple: redefine urban dining with high-energy speed and premium, bold flavors.
            </span>
            <span>
              We aren't just a restaurant; we're a sanctuary for the hungry soul. From our signature gold-crusted fries to our hand-crafted urban burgers, every bite is a celebration of craftsmanship and street-inspired passion.
            </span>
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto w-full">
        ...
        <div className="bg-card-bg border border-white/5 rounded-3xl p-8 flex flex-col justify-between gap-6 hover:border-brand-gold/20 transition-colors duration-300">
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3 text-brand-gold">
              <Clock size={22} />
              <h2 className="text-xl font-bold uppercase tracking-wide">Opening Times</h2>
            </div>
        ...
        <div className="bg-card-bg border border-white/5 rounded-3xl p-8 flex flex-col gap-6 hover:border-brand-gold/20 transition-colors duration-300" id="contact">
          ...
          <div className="flex flex-col gap-6 my-auto">
            ...
            <a
              href="tel:+1234567890"
              className="flex items-center gap-4 group p-3 rounded-2xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/5"
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs text-white/40 uppercase tracking-wider">Phone</span>
      ...
      <section className="max-w-4xl mx-auto w-full flex flex-col gap-6">
        <h2 className="text-2xl font-bold uppercase tracking-wider text-center md:text-left text-white">
          Find Us Here
        </h2>
          ...
          <div className="p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-t border-white/5 bg-black/40">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-white/80 font-light leading-relaxed">
                123 Urban Flavor Street, New York, NY 10001
              </p>
            </div>
            <a
      ...
      <section className="max-w-4xl mx-auto w-full flex flex-col gap-10">
        <div className="flex flex-col gap-3 text-center max-w-xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-wide text-white">
            The Faces of Take Five
          </h2>
          <p className="text-xs sm:text-sm text-white/60 leading-relaxed font-light">
            A small team with big hearts, dedicated to making your break the highlight of your day.
          </p>
        </div>
